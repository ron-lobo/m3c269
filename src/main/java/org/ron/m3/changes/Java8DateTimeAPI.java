...
public class Java8DateTimeAPI {
    ...
    public void introduction() {
        Utils.printMethod("introduction");
    }

    public void localDate() {
        Utils.printMethod("localDate");
    ...
    public void localDateTime() {
        Utils.printMethod("localDateTime");
    ...
    public void instantDurationPeriod() {
        Utils.printMethod("instantDurationPeriod");
        ...
        // Duration - these are exact and are measured in seconds & nanoseconds
